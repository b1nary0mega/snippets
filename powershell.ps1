...
PS > Invoke-Command MACHINE_NAME {iex((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/b1nary0mega/incident-response/master/JCERT.ps1')); JCERT.ps1}
